...
/* harmony import */ var _index_c3ff7f2e_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__("k4ps");
...
const Nav = class {
  ...
  async componentDidLoad() {
    this.rootChanged();
    this.gesture = (await __webpack_require__.e(/* import() */ 16).then(__webpack_require__.bind(null, "IYAk"))).createSwipeBackGesture(this.el, this.canStart.bind(this), this.onStart.bind(this), this.onMove.bind(this), this.onEnd.bind(this));
    this.swipeGestureChanged();
  }
  disconnectedCallback() {
    for (const view of this.views) {
      Object(_index_c3ff7f2e_js__WEBPACK_IMPORTED_MODULE_4__[/* l */ "h"])(view.element, _index_c3ff7f2e_js__WEBPACK_IMPORTED_MODULE_4__[/* d */ "e"]);
      view._destroy();
    }
    if (this.gesture) {
  ...
  postViewInit(enteringView, leavingView, ti) {
    ...
    if (destroyQueue && destroyQueue.length > 0) {
      for (const view of destroyQueue) {
        Object(_index_c3ff7f2e_js__WEBPACK_IMPORTED_MODULE_4__[/* l */ "h"])(view.element, _index_c3ff7f2e_js__WEBPACK_IMPORTED_MODULE_4__[/* b */ "c"]);
        Object(_index_c3ff7f2e_js__WEBPACK_IMPORTED_MODULE_4__[/* l */ "h"])(view.element, _index_c3ff7f2e_js__WEBPACK_IMPORTED_MODULE_4__[/* c */ "d"]);
        Object(_index_c3ff7f2e_js__WEBPACK_IMPORTED_MODULE_4__[/* l */ "h"])(view.element, _index_c3ff7f2e_js__WEBPACK_IMPORTED_MODULE_4__[/* d */ "e"]);
      }
  ...
  async transition(enteringView, leavingView, ti) {
    ...
    const animationOpts = Object.assign({ mode, showGoBack: this.canGoBackSync(enteringView), baseEl: this.el, animationBuilder: this.animation || opts.animationBuilder || _ionic_global_63a97a32_js__WEBPACK_IMPORTED_MODULE_1__["c"].get('navAnimation'), progressCallback, animated: this.animated && _ionic_global_63a97a32_js__WEBPACK_IMPORTED_MODULE_1__["c"].getBoolean('animated', true), enteringEl,
      leavingEl }, opts);
    const { hasCompleted } = await Object(_index_c3ff7f2e_js__WEBPACK_IMPORTED_MODULE_4__[/* t */ "j"])(animationOpts);
    ...
    for (let i = views.length - 1; i >= 0; i--) {
      ...
      if (element) {
        if (i > activeViewIndex) {
          ...
          // let's unload it
          Object(_index_c3ff7f2e_js__WEBPACK_IMPORTED_MODULE_4__[/* l */ "h"])(element, _index_c3ff7f2e_js__WEBPACK_IMPORTED_MODULE_4__[/* d */ "e"]);
          this.destroyView(view);
        }
        else if (i < activeViewIndex) {
          // this view comes before the active view
          // and it is not a portal then ensure it is hidden
          Object(_index_c3ff7f2e_js__WEBPACK_IMPORTED_MODULE_4__[/* s */ "i"])(element, true);
        }
      }
    }
  }
  ...
  onEnd(shouldComplete, stepValue, dur) {
    if (this.sbAni) {
      ...
      if (!shouldComplete) {
        ...
        newStepValue += Object(_cubic_bezier_eea9a7a9_js__WEBPACK_IMPORTED_MODULE_2__[/* g */ "a"])([0, 0], [1, 0], [0.68, 0.28], [1, 1], stepValue)[0];
      }
      else {
        newStepValue += Object(_cubic_bezier_eea9a7a9_js__WEBPACK_IMPORTED_MODULE_2__[/* g */ "a"])([0, 0], [0.32, 0.72], [0, 1], [1, 1], stepValue)[0];
      }
...
const NavLink = class {
  ...
  render() {
    return (Object(_index_7a8b7a1c_js__WEBPACK_IMPORTED_MODULE_0__[/* h */ "j"])(_index_7a8b7a1c_js__WEBPACK_IMPORTED_MODULE_0__[/* H */ "c"], { onClick: this.onClick }));
  }
  get el() { return Object(_index_7a8b7a1c_js__WEBPACK_IMPORTED_MODULE_0__[/* i */ "k"])(this); }
};
