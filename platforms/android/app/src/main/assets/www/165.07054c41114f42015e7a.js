...
const Toast = class {
  constructor(hostRef) {
    ...
    this.didPresent = Object(_index_7a8b7a1c_js__WEBPACK_IMPORTED_MODULE_0__[/* e */ "g"])(this, "ionToastDidPresent", 7);
    this.willPresent = Object(_index_7a8b7a1c_js__WEBPACK_IMPORTED_MODULE_0__[/* e */ "g"])(this, "ionToastWillPresent", 7);
    this.willDismiss = Object(_index_7a8b7a1c_js__WEBPACK_IMPORTED_MODULE_0__[/* e */ "g"])(this, "ionToastWillDismiss", 7);
    this.didDismiss = Object(_index_7a8b7a1c_js__WEBPACK_IMPORTED_MODULE_0__[/* e */ "g"])(this, "ionToastDidDismiss", 7);
    ...
    this.dispatchCancelHandler = (ev) => {
      ...
      if (Object(_overlays_28c23c35_js__WEBPACK_IMPORTED_MODULE_2__[/* i */ "j"])(role)) {
   ...
   */
  async present() {
    await Object(_overlays_28c23c35_js__WEBPACK_IMPORTED_MODULE_2__[/* d */ "e"])(this, 'toastEnter', iosEnterAnimation, mdEnterAnimation, this.position);
    if (this.duration > 0) {
  ...
  dismiss(data, role) {
    ...
    return Object(_overlays_28c23c35_js__WEBPACK_IMPORTED_MODULE_2__[/* f */ "g"])(this, data, role, 'toastLeave', iosLeaveAnimation, mdLeaveAnimation, this.position);
  }
  /**
   * Returns a promise that resolves when the toast did dismiss.
   */
  onDidDismiss() {
    return Object(_overlays_28c23c35_js__WEBPACK_IMPORTED_MODULE_2__[/* g */ "h"])(this.el, 'ionToastDidDismiss');
  }
  /**
   * Returns a promise that resolves when the toast will dismiss.
   */
  onWillDismiss() {
    return Object(_overlays_28c23c35_js__WEBPACK_IMPORTED_MODULE_2__[/* g */ "h"])(this.el, 'ionToastWillDismiss');
  }
  getButtons() {
  ...
  async callButtonHandler(button) {
    if (button && button.handler) {
      ...
      try {
        const rtn = await Object(_overlays_28c23c35_js__WEBPACK_IMPORTED_MODULE_2__[/* s */ "n"])(button.handler);
        if (rtn === false) {
  ...
  renderButtons(buttons, side) {
    ...
    return (Object(_index_7a8b7a1c_js__WEBPACK_IMPORTED_MODULE_0__[/* h */ "j"])("div", { class: buttonGroupsClasses }, buttons.map(b => Object(_index_7a8b7a1c_js__WEBPACK_IMPORTED_MODULE_0__[/* h */ "j"])("button", { type: "button", class: buttonClass(b), tabIndex: 0, onClick: () => this.buttonClick(b), part: "button" }, Object(_index_7a8b7a1c_js__WEBPACK_IMPORTED_MODULE_0__[/* h */ "j"])("div", { class: "toast-button-inner" }, b.icon &&
      Object(_index_7a8b7a1c_js__WEBPACK_IMPORTED_MODULE_0__[/* h */ "j"])("ion-icon", { icon: b.icon, slot: b.text === undefined ? 'icon-only' : undefined, class: "toast-icon" }), b.text), mode === 'md' && Object(_index_7a8b7a1c_js__WEBPACK_IMPORTED_MODULE_0__[/* h */ "j"])("ion-ripple-effect", { type: b.icon !== undefined && b.text === undefined ? 'unbounded' : 'bounded' })))));
  }
  render() {
    ...
    return (Object(_index_7a8b7a1c_js__WEBPACK_IMPORTED_MODULE_0__[/* h */ "j"])(_index_7a8b7a1c_js__WEBPACK_IMPORTED_MODULE_0__[/* H */ "c"], { style: {
      ...
      }, class: Object(_theme_ff3fc52f_js__WEBPACK_IMPORTED_MODULE_4__[/* c */ "a"])(this.color, Object.assign(Object.assign({ [mode]: true }, Object(_theme_ff3fc52f_js__WEBPACK_IMPORTED_MODULE_4__[/* g */ "b"])(this.cssClass)), { 'toast-translucent': this.translucent })), tabindex: "-1", onIonToastWillDismiss: this.dispatchCancelHandler }, Object(_index_7a8b7a1c_js__WEBPACK_IMPORTED_MODULE_0__[/* h */ "j"])("div", { class: wrapperClass }, Object(_index_7a8b7a1c_js__WEBPACK_IMPORTED_MODULE_0__[/* h */ "j"])("div", { class: "toast-container", part: "container" }, this.renderButtons(startButtons, 'start'), Object(_index_7a8b7a1c_js__WEBPACK_IMPORTED_MODULE_0__[/* h */ "j"])("div", { class: "toast-content" }, this.header !== undefined &&
      Object(_index_7a8b7a1c_js__WEBPACK_IMPORTED_MODULE_0__[/* h */ "j"])("div", { class: "toast-header", part: "header" }, this.header), this.message !== undefined &&
      Object(_index_7a8b7a1c_js__WEBPACK_IMPORTED_MODULE_0__[/* h */ "j"])("div", { class: "toast-message", part: "message", innerHTML: Object(_index_9e3fe806_js__WEBPACK_IMPORTED_MODULE_3__[/* s */ "a"])(this.message) })), this.renderButtons(endButtons, 'end')))));
  }
  get el() { return Object(_index_7a8b7a1c_js__WEBPACK_IMPORTED_MODULE_0__[/* i */ "k"])(this); }
};
const buttonClass = (button) => {
  return Object.assign({ 'toast-button': true, 'toast-button-icon-only': button.icon !== undefined && button.text === undefined, [`toast-button-${button.role}`]: button.role !== undefined, 'ion-focusable': true, 'ion-activatable': true }, Object(_theme_ff3fc52f_js__WEBPACK_IMPORTED_MODULE_4__[/* g */ "b"])(button.cssClass));
};
Toast.style = {
  ios: toastIosCss,
  md: toastMdCss
