...
/* harmony import */ var _spinner_configs_cd7845af_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__("h3R7");
...
const Spinner = class {
  ...
  render() {
    ...
    const spinner = _spinner_configs_cd7845af_js__WEBPACK_IMPORTED_MODULE_3__[/* S */ "a"][spinnerName] || _spinner_configs_cd7845af_js__WEBPACK_IMPORTED_MODULE_3__[/* S */ "a"]['lines'];
    ...
    return (Object(_index_7a8b7a1c_js__WEBPACK_IMPORTED_MODULE_0__[/* h */ "j"])(_index_7a8b7a1c_js__WEBPACK_IMPORTED_MODULE_0__[/* H */ "c"], { class: Object(_theme_ff3fc52f_js__WEBPACK_IMPORTED_MODULE_2__[/* c */ "a"])(self.color, {
        [mode]: true,
...
const buildCircle = (spinner, duration, index, total) => {
  ...
  return (Object(_index_7a8b7a1c_js__WEBPACK_IMPORTED_MODULE_0__[/* h */ "j"])("svg", { viewBox: data.viewBox || '0 0 64 64', style: data.style }, Object(_index_7a8b7a1c_js__WEBPACK_IMPORTED_MODULE_0__[/* h */ "j"])("circle", { transform: data.transform || 'translate(32,32)', cx: data.cx, cy: data.cy, r: data.r, style: spinner.elmDuration ? { animationDuration: duration + 'ms' } : {} })));
};
const buildLine = (spinner, duration, index, total) => {
  const data = spinner.fn(duration, index, total);
  data.style['animation-duration'] = duration + 'ms';
  return (Object(_index_7a8b7a1c_js__WEBPACK_IMPORTED_MODULE_0__[/* h */ "j"])("svg", { viewBox: data.viewBox || '0 0 64 64', style: data.style }, Object(_index_7a8b7a1c_js__WEBPACK_IMPORTED_MODULE_0__[/* h */ "j"])("line", { transform: "translate(32,32)", y1: data.y1, y2: data.y2 })));
};
